        ...
        <div class="container-fluid" >
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" id="pgg" href="">Додати симптом</a>
                    </li>
                    <li>
            ...
            <table class = "table table-striped" >
                <c:forEach items="${symptomsList}" var="symptom" varStatus="loop">
                    <tr>
                        ...
                        <td> <a class="glyphicon glyphicon-pencil" href="">  Edit</a></td>
                        <td>
                            <form method="POST" action="/admin-page/illness/${symptom.getId()}">
                            <button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Delete </button>
                            </form>
                        </td>
                    </tr>
                </c:forEach>
