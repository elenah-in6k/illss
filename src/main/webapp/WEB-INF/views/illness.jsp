...
<head>
    <%
        Illness illness = (Illness) request.getAttribute("illness");
    %>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<c:url value="/resources/css/creative.css"/>" type="text/css">    <title><%=illness.getName()%>
    </title>
</head>
<body>
...
<div class="mycont">
<div class="container ">
    <h2><%=illness.getName()%></h2>
    <div class="">
        <div>Опис</div>
        <div><%=illness.getDescription()%></div>
    </div>
</div></div>
</body>
</html>